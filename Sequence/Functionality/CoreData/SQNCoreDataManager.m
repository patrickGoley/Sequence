...
@implementation SQNCoreDataManager
...
- (NSManagedObjectContext *)contextForThread:(NSThread *)thread {
    ...
    static NSString *threadContextKey = @"com.sequence.threadContext";
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    if (!_managedObjectModel) {
        ...
        NSURL *modelFileURL = [[NSBundle mainBundle] URLForResource:@"SequenceModel" withExtension:@"momd"];
